...
import { reShapeValidationErrorResponse } from './common/exceptions/reshape-validation-error-response.js';
...
async function bootstrap() {
	...
	app.useGlobalPipes(
		new ValidationPipe({
			exceptionFactory: (errors) => reShapeValidationErrorResponse(errors),
		}),
	);
	...
	const config = new DocumentBuilder()
		...
		.setDescription(
			'A task tracker. A user can create a task, list tasks, \
